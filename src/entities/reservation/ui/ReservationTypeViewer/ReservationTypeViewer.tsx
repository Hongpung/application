...
export const ReservationTypeViewer: React.FC<ReservationTypeViewerProps> = (props) => {
        ...
        <View>
            ...
            <View style={{ marginHorizontal: 44, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <View style={{ width: 218, height: 36, borderRadius: 5, flexDirection: 'row', alignItems: 'center' }}>
                    <View style={[{ width: 108, alignItems: 'center', borderBottomLeftRadius: 5, borderTopLeftRadius: 5, height: 36, justifyContent: 'center', borderWidth: 1, borderRightWidth: 0.5, borderColor: reservationType === 'REGULAR' ? Color['blue500'] : Color['red500'] }, reservationType === 'REGULAR' && { backgroundColor: Color['blue100'] }]}
                    >
                        <Text style={[style.buttonText, reservationType === 'REGULAR' ? { color: Color['blue600'] } : { color: Color['red300'] }]}>
                            예
                        </Text>
                    </View>
                    <View style={[{ width: 108, alignItems: 'center', borderBottomRightRadius: 5, borderTopRightRadius: 5, height: 36, justifyContent: 'center', borderWidth: 1, borderLeftWidth: 0.5, borderColor: reservationType === 'REGULAR' ? Color['blue500'] : Color['red500'] }, reservationType !== 'REGULAR' && { backgroundColor: Color['red100'] }]}
                    >
