...
import { BorrowInstrumentsViewer, ParticipatorsViewer, useLoadReservationDetailFetch } from "@hongpung/src/entities/reservation"
...
const ReservationCreatePage: React.FC<ReservationStackProps<'ReservationDetail'>> = ({ navigation, route }) => {

    const { reservationId } = route.params
    const { data: reservation, isLoading, error } = useLoadReservationDetailFetch({ reservationId })
    ...
    const { date, startTime, endTime, title, borrowInstruments, creatorName, participationAvailable, participators, reservationType, creatorId, creatorNickname } = reservation;
            ...
            <View>
                ...
                <ScrollView contentContainerStyle={styles.scrollView}>
                    ...
                    <View style={styles.row}>
                        ...
                        <Text style={styles.value}>{`${creatorName}${!!creatorNickname ? ` (${creatorNickname})` : ''}`}</Text>
                    </View>
        ...
        <View>
            ...
            <ScrollView contentContainerStyle={styles.scrollView}>
...

                {
                    ...
                    <View>
                        <DeleteReservationButton reservationId={reservationId} date={date} />
                    </View>
                }

                {/* 나가기 버튼 */}

                {creatorId !== loginUser?.memberId && isEditible(date) && participators.some(participator => participator.memberId === loginUser?.memberId) &&
            ...
            {/* 수정하기 버튼 */}
            {
                ...
                <View style={styles.bottomButton}>
                    <EnterEditButton
                        navigateToEditReservationPage={() => navigation.push('ReservationStack', { screen: 'inReservation', params: { reservationId, date } })}
                    />
                </View>
            }
        </View>
