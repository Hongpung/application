...
const BannerSliderWithIndicator: React.FC<BannerSliderProps & { onPressIndicator: () => void }> = ({ banners, onPressIndicator }) => {
                    ...
                    bannerLength == 0 ?
                        ...
                        bannerLength > 1 ?
                            <>
                                ...
                                <BannerIndicator bannerIndex={bannerIndex} bannerLength={bannerLength} onPress={onPressIndicator} />
                            </>
                            :
