...
import { ReservationType } from "@hongpung/src/entities/reservation"
...
type ReservationTypeSelectorProps = {
    ...
    setParticipationAvailable: (changedBoolean: boolean) => void
}

export const ReservationTypeSelector: React.FC<ReservationTypeSelectorProps> = ({ reservationType, setReservationType, participationAvailable, setParticipationAvailable }) => {
