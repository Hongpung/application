...
export const FullCalendar: React.FC<FullCalendarProps> = (props) => {
    ...
    const { calendarMonth, datesInMonth, incrementMonth, decrementMonth, onClickDate, reservationsData, error, isLoading } = props;
    ...
    if (error || reservationsData === null) {

        Alert.alert('오류', error?.message || '알 수 없는 오류입니다.', [{ text: '확인', onPress: () => { } }])
