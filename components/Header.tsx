...
interface HeaderProps {
    leftButton: string, HeaderName?: string, RightButton?: string, RightAction?: () => void
}

const Header: React.FC<HeaderProps> = ({ leftButton, HeaderName, RightButton, RightAction }) => {
